...
var _ljud : Array = [preload("res://scener/ljud/Draco_skott.tscn"), preload("res://scener/ljud/silenced_pistol_skott.tscn"), preload("res://scener/ljud/empty_skott.tscn")]
var skott_ljud

var empty_shell = preload("res://scener/Test/big_bullet_test.tscn")
var mag = preload("res://scener/Vapen/MAG/ar_3_mag.tscn")
var player
@export var is_reloading : bool = false
@export var sync_pos = Vector2(0, 0)

@export var silencer_on : bool = false
@export var mb_on : bool = false
...
func _process(delta):
	...
	if Global.mode == 0:
		...
		skott_ljud = _ljud[0]
	if mb_on and !silencer_on:
		$Accessories/Muzzle_boost.show()
		$Sprite2D/Marker2D.position = Vector2(35.667, -2.667)
		$AnimationPlayer.speed_scale = 1.5
	elif !mb_on:
		$Accessories/Muzzle_boost.hide()
		$AnimationPlayer.speed_scale = 1
		$Sprite2D/Marker2D.position = Vector2(28.667, -2.667)
