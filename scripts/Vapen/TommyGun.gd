...
var _ljud : Array = [preload("res://scener/ljud/Tommy_skott.tscn"), preload("res://scener/ljud/silenced_pistol_skott.tscn"), preload("res://scener/ljud/empty_skott.tscn")]
var skott_ljud
...
func _ready():
	$Sprite2D/Muzzle.visible = false
	player = get_parent().get_parent()
	ammo += max_ammo
	
	$Sprite2D/Marker2D.position = Vector2(29.222, -6.111)
	skott_ljud = _ljud[0]
...
func _on_tommy_anims_animation_finished(anim_name):
	if anim_name == "recoil":
		can_shoot = true
		get_parent().shooting = false
