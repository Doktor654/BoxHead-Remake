...
@onready var item_container = $BoxScrollContainer/ItemContainer
@onready var case_container = $BoxScrollContainer
@onready var panel = $Panel

var blue_range = range(1, 61)
var purple_range = range(61, 90)
var red_range = range(90, 100)
var gold_range = range(100, 102)
