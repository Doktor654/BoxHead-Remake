...
var _ljud : Array = [preload("res://scener/ljud/Garand_skott.tscn"), preload("res://scener/ljud/silenced_pistol_skott.tscn"), preload("res://scener/ljud/empty_skott.tscn")]
var skott_ljud
...
func _on_garand_anim_animation_finished(anim_name):
	if anim_name == "recoil":
		can_shoot = true
		get_parent().shooting = false
	if anim_name == "reload":
